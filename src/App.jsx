  ...
  return (
    <section className="min-h-[100vh] max-h-fit flex justify-center bg-slate-900">
      <div className="w-[75%] flex flex-col">
        <div className="">
          <h1 className="font-sans text-center py-8 text-4xl font-extrabold  tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Write an essay using just a single word!</h1>
